...
class PHSTrainingPipeline:
    def __init__(
        self, data_path=None, model_path="models/risk_prediction/phs_model.joblib"
    ):
    ...
    def train_model(self):
        print("--- Starting PHS Model Training ---")
...
def main():
    ...
    parser.add_argument(
        "--data_path", default="data/processed/analysis_ready_dataset.parquet"
    )
    parser.add_argument(
        "--model_out", default="models/risk_prediction/phs_model.joblib"
    )
