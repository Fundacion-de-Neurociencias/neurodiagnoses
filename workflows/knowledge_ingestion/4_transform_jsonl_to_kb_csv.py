...
def main():
    ...
    # Create a dictionary to hold the data for each axis
    kb_data = {
        1: [],
        2: [],
        3: []
    ...
    for axis, entries in kb_data.items():
        ...
        with open(output_csv_path, 'w', newline='', encoding='utf-8') as f:
            ...
            for entry in entries:
                # Prepare the row, handling potentially missing values
                ...
                row = {
                    ...
                    "ci_lower": confidence_interval[0] if confidence_interval and len(confidence_interval) > 0 else None,
                    "ci_upper": confidence_interval[1] if confidence_interval and len(confidence_interval) > 1 else None,
