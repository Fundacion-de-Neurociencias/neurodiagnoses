...
def parse_vascular_data(
    patient_id: int, csv_path: str = "data/simulated/vascular_data.csv"
) -> Optional[Dict]:
    """
    ...
    try:
        ...
        vascular_profile = {
            "white_matter_hyperintensity_volume": float(
                patient_data["white_matter_hyperintensity_volume"].iloc[0]
            ),
