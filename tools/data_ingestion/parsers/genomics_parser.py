...
from tools.ontology.neuromarker import GeneticData, PatientRecord
...
def parse_genomics_data(patient_id, csv_path) -> PatientRecord:
    ...
    try:
        ...
        if "APOE4_alleles" in patient_data.columns:
            ...
            record.genetics.disease_specific_risk.append(
                f"APOE_e{int(patient_data['APOE4_alleles'].iloc[0])}"
            )
