...
class Axis2MolecularPipeline:
    ...
    def __init__(
        ...
        plot_path="docs/assets/shap_summary_axis2.png",
    ):  # Output path for the plot
        self.data_path = data_path
        self.model_path = model_path
        self.plot_path = plot_path
        self.features = [
            "biomarkers_Age_value",
            "biomarkers_MMSE_value",
            "biomarkers_pTau_value",
            "biomarkers_Abeta42_value",
    ...
    def train_and_evaluate(self):
        ...
        """
        print(
            f"--- Starting Axis 2 model training & evaluation from '{self.data_path}' ---"
        )
