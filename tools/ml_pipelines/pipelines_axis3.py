...
class Axis3PhenotypicPipeline:
    def __init__(self):
        ...
        self.feature_order = ['age', 'cortical_thickness', 'ventricular_volume', 'MMSE', 'hippocampal_volume']
    ...
    def predict(self, features_dict):
        ...
        rename_map = {
            col.lower(): col for col in self.feature_order
        ...
        if not all(col in input_df.columns for col in self.feature_order):
            ...
            raise KeyError(f"❌ Missing required features for Axis 3 prediction: {missing}")
